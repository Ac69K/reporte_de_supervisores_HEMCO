...
function exportHTML(){
  ...
  H4.forEach(function(hh){var v=ozAcum['h'+hh];body+='<div style="background:rgba(255,255,255,0.1);border-radius:6px;padding:6px 12px;text-align:center"><div style="font-size:10px;color:rgba(255,255,255,0.6)">H'+hh+'</div><div style="font-size:16px;font-weight:700;color:#76C810">'+(v!==undefined?v+'oz':'—')+'</div></div>';});
  body+='</div></div>';
